				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li  >
								<a href="/MedicalRecordsAPP_Backstage/dep/ment/druguse">药品及设备使用信息管理</a>
							</li>
							<li class="active" >
								修改
							</li>
								...
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="druguse!modifyDrugUseAfter" method="post">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="druguse.medical_ID" id="form-field-1" class="col-xs-10 col-sm-5 " readonly value="${druguse.medical_ID }" />
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>药品编号： </label>

											<div class="col-sm-9">
												<input type="text" nullmsg="请输入药品编号！" datatype="s2-20" errormsg="药品编号最少为2个字符，最多为20个字符！" name="druguse.drug_ID" id="form-field-1" class="col-xs-10 col-sm-5"  value="${druguse.drug_ID }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>药量： </label>

											<div class="col-sm-9">
												<input type="text" nullmsg="请输入药量！" datatype="*1-11" errormsg="药量最少为1个字符，最多为11个字符！" name="druguse.druguse_num" id="form-field-1" class="col-xs-10 col-sm-5"  value="${druguse.druguse_num }"/>
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-angle-right bigger-110"></i>&nbsp;<span class="middle">单位：克</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>当前时间： </label>

											<div class="col-sm-9">
												<input type="text" nullmsg="请输入当前时间！" name="druguse.druguse_time" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker"  value="${druguse.druguse_time }" style="width:357px;" />
											</div>
										</div>
										<div class="space-4"></div>
