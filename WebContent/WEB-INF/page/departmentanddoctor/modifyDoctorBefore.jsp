					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="departmentanddoctor!modifyDepartmentAndDoctorAfter" method="post" id="form_doc" class="form-horizontal">
								<div>
										...
										<div class="col-xs-12 col-sm-9">
											...
											<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-row">
													<div class="profile-info-name"> <span style="color:#b20202;">* </span>职位 </div>

													<div class="profile-info-value">
														<span class="editable" id="about">
														<input type="text" nullmsg="请输入职位！" datatype="s1-2" errormsg="职位请填‘普通’或者‘专家’！" name="doctorBaseInfo.doctorInfo_position" value="${doctorBaseInfo.doctorInfo_position}" size="50" style="border-style:none;padding:10">
													...
													<div class="profile-info-row">
													<div class="profile-info-name"> <span style="color:#b20202;">* </span>坐诊类型 </div>
													...
													<div class="profile-info-row">
													<div class="profile-info-name"> <span style="color:#b20202;">* </span>办公室地址 </div>

													<div class="profile-info-value">
														<span class="editable" id="about">
														<input type="text" nullmsg="请输入办公室地址！" datatype="s10-100" errormsg="办公室地址最少为10个字符，最多为100个字符！" name="doctorBaseInfo.doctorInfo_Oaddress" value="${doctorBaseInfo.doctorInfo_Oaddress}" size="50" style="border-style:none;padding:10">
														</span>
													</div>
													
												</div>
												<div class="profile-info-row">
													<div class="profile-info-name"> <span style="color:#b20202;">* </span>所属科室 </div>
