					...
					<hr>
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="hospitalbaseinfo!modifyHospitalAfter" enctype="multipart/form-data" method="post" >
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>医院名称： </label>

											<div class="col-sm-9">
												<input type="text" nullmsg="请输入医院名称！" datatype="s2-100" errormsg="医院名称最少为2个字符，最多为100个字符！" name="hospital.hospital_name" id="form-field-1" class="col-xs-10 col-sm-5"  value="${ hospital.hospital_name }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><span style="color:#b20202;">* </span> 医院地址： </label>

											<div class="col-sm-9">
												<input type="text" nullmsg="请输入医院地址！" datatype="s2-100" errormsg="医院地址最少为2个字符，最多为100个字符 name="hospital.hospital_address"  id="form-field-1" class="col-xs-10 col-sm-5"  value="${hospital.hospital_address }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>联系电话： </label>

											<div class="col-sm-9">
												<input type="text" nullmsg="请输入联系电话！" name="hospital.hospital_phone" id="form-field-1" class="col-xs-10 col-sm-5"  value="${hospital.hospital_phone }"/>
