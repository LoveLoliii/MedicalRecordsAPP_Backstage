								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										<div class="col-xs-12 col-sm-3 center">
												...
												<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
													<div class="inline position-relative">
														<a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
															...
															&nbsp;
															<span class="white">${hospital.hospital_name}</span>
														</a>
													</div>
												</div>
											</div>
											...
											<div class="clearfix">
												<div class="grid2">
													<span class="bigger-175 blue">${departmentNum }</span>
												...
												<div class="grid2">
													<span class="bigger-175 blue">${doctorNum }</span>
										...
										<div class="col-xs-12 col-sm-9">
											...
											<h4 class="blue">
												<span class="middle">欢迎您&nbsp;&nbsp;&nbsp;&nbsp;<small>医院管理员&nbsp;&nbsp;<i class="icon-double-angle-right"></i>&nbsp;${doctorBaseInfo.doctorInfo_name }</small></span>
											</h4>
											<hr>
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													<div class="profile-info-name"> 医院编号 </div>

													<div class="profile-info-value">
														<span class="editable" id="username">${hospital.hospital_ID }</span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> 医院地址 </div>

													<div class="profile-info-value">
														<span class="editable" id="address">${hospital.hospital_address}</span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> 医院简介 </div>

													<div class="profile-info-value">
														<span class="editable" id="info">${hospital.hospital_info}
														</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="phone">${hospital.hospital_phone}</span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> 医院网站 </div>

													<div class="profile-info-value">
														<span class="editable" id="website">
														<a href="http://${hospital.hospital_webSite}" target="_blank">${hospital.hospital_webSite}</a></span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> 医院状态 </div>

													<div class="profile-info-value">
														<span class="editable" id="state">
														<c:if test="${hospital.hospital_state==1 }">运营中</c:if>
														<c:if test="${hospital.hospital_state==0 }">歇业中</c:if>
														</span>
													</div>
												</div>
											</div>
											...
											<s:url id="url"  action="hospitalbaseinfo" method="modifyHospitalBefore">
												<s:param name="hospital.hospital_ID" value="hospital.hospital_ID" />
											</s:url>
