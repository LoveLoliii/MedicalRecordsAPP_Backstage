				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li  >
								<a href="/MedicalRecordsAPP_Backstage/dep/ment/drug">挂药费基本信息管理</a>
							</li>
							<li  class="active">
								修改
							</li>
								...
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="registrationfee!modifyRegistrationFeeAfter.action" method="post">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入坐诊类型！" datatype="s2-11" errormsg="坐诊类型最少为2个字符，最多为11个字符！"name="registrationfee.doctorInfo_typeName" id="form-field-1" class="col-xs-10 col-sm-5"  value="${registrationfee.doctorInfo_typeName }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入挂号费！" datatype="s1-4" errormsg="挂号费范围为1-9999元！" name="registrationfee.registrationfee_fee" id="form-field-1" class="col-xs-10 col-sm-5"  value="${registrationfee.registrationfee_fee }"/>
