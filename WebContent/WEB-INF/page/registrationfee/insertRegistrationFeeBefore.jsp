				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li  >
								<a href="/MedicalRecordsAPP_Backstage/dep/ment/registrationfee">挂药费基本信息管理</a>
							</li>
							<li  >
								<a href="/MedicalRecordsAPP_Backstage/dep/ment/registrationfee!insertRegistrationFeeBefore.action">增加坐诊类型</a>
							</li>
						</ul><!-- .breadcrumb -->
								...
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="registrationfee!insertRegistrationFeeAfter.action" method="post">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入编号！" datatype="s2-20" errormsg="编号最少为2个字符，最多为20个字符！" name="registrationfee.registrationfee_ID" id="form-field-1" class="col-xs-10 col-sm-5 "/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text"  nullmsg="请输入坐诊类型！" datatype="s2-20" errormsg="坐诊类型最少为2个字符，最多为20个字符！" name="registrationfee.doctorInfo_typeName" id="form-field-1" class="col-xs-10 col-sm-5 "/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><span style="color:#b20202;">* </span> 挂号费： </label>

											<div class="col-sm-9">
												<input type="text"  nullmsg="请输入挂号费！" datatype="s1-4" errormsg="挂号费范围为1-9999！"  name="registrationfee.registrationfee_fee" id="form-field-1" class="col-xs-10 col-sm-5 "/>
											</div>
										</div>
										<div class="space-4"></div>
