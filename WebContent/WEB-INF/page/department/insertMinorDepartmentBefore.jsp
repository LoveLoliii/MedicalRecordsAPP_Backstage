				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
							<a href="/MedicalRecordsAPP_Backstage/dep/ment/maindepartment!insertMinorDepartmentBefore.action">增加次科室</a>
							</li>
						</ul><!-- .breadcrumb -->
								...
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="maindepartment!insertMinorDepartmentAfter.action" method="post">
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>科室编号： </label>

											<div class="col-sm-9">
												<input type="text" nullmsg="请输入科室编号！" datatype="s2-20" errormsg="科室编号最少为2个字符，最多为20个字符！"name="minordepartment.minordepartment_ID" id="form-field-1" class="col-xs-10 col-sm-5 "/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text"  nullmsg="请输入科室名称！" datatype="s2-10" errormsg="科室名称最少为2个字符，最多为10个字符！ name="minordepartment.minordepartment_name" id="form-field-1" class="col-xs-10 col-sm-5"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select class="form-control" nullmsg="请选择所属科室名称！"  id="form-field-select-1" name="minordepartment.maindepartment_ID" style="width:357px;">
													<option>--请选择--</option>
