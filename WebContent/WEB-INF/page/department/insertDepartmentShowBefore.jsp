								...
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_save" role="form" action="maindepartment!insertMainDepartmentAfter.action" method="post">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入科室编号！" datatype="s2-20" errormsg="科室编号最少为2个字符，最多为20个字符！" name="maindepartment.maindepartment_ID" id="form-field-1" class="col-xs-10 col-sm-5 "/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入科室名称！" datatype="s2-10" errormsg="科室名称最少为2个字符，最多为10个字符！" name="maindepartment.maindepartment_name" id="form-field-1" class="col-xs-10 col-sm-5"/>
											</div>
										</div>
										<div class="space-4"></div>
