				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
							<a href="/MedicalRecordsAPP_Backstage/dep/ment/maindepartment!showMinordepartment.action?maindepartment.maindepartment_ID=${maindepartment.maindepartment_ID}">查看属下科室</a>
							</li>
						</ul><!-- .breadcrumb -->
