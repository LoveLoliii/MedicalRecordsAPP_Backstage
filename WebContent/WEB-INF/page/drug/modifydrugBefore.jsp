								...
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="drug!modifyDrugAfter" method="post">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入药品（设备）名称！" datatype="s2-20" errormsg="药品（设备）名称最少为2个字符，最多为20个字符！" name="drug.drug_name" id="form-field-1" class="col-xs-10 col-sm-5 "  value="${drug.drug_name }" />
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入剂量！" datatype="*2-11" errormsg="剂量最少为2个字符，最多为11个字符！" name="drug.drug_num" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_num }"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入价格！" name="drug.drug_price" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_price }"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入生产日期！" name="drug.drug_time" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker"  value="${drug.drug_time }" style="width:357px;" />
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入保质期！" name="drug.drug_period" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_period }"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入制药厂！" datatype="s2-140" errormsg="制药厂最少为2个字符，最多为40个字符！" name="drug.drug_produce_factory" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_produce_factory }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" nullmsg="请输入药品类型！" datatype="s2-10" errormsg="药品类型最少为2个字符，最多为10个字符！" name="drug.drug_style" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_style }"/>
											</div>
										</div>
										<div class="space-4"></div>
