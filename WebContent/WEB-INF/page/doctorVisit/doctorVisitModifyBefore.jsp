				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li  >
								<a href="/MedicalRecordsAPP_Backstage/dep/ment/doctorVisit">坐诊时间表管理</a>
							</li>
					...
					<hr>
								<div class="col-xs-12">
									<form class="form-horizontal" role="form" action="doctorVisit!modifydoctorVisitAfter.action" id="form_doc">
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1" ><span style="color:#b20202;">* </span> 日期： </label>

											<div class="col-sm-9">
												<input type="text" name="doctorVisit.doctorVisit_date" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" nullmsg="请输入日期！"   value="${doctorVisit.doctorVisit_date }" style="width:357px;" />
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><span style="color:#b20202;">* </span> 时间类型： </label>
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-9"> <span style="color:#b20202;">* </span>可挂号数量： </label>

											<div class="col-sm-9">
												<input type="text" nullmsg="请输入可挂号数量！" datatype="*1-3" errormsg="可挂号数量最少为1位，最多3位！" name="doctorVisit.doctorVisit_regNunber" id="form-field-1" class="col-xs-10 col-sm-5"  value="${doctorVisit.doctorVisit_regNunber }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>反馈意见： </label>
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>反馈状态： </label>
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>时间状态： </label>
											<div class="col-sm-9">
												<label>
