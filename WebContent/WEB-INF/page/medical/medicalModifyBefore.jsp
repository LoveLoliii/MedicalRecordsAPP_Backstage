					...
					<hr>
								<div class="col-xs-12">
									<form class="form-horizontal" role="form" action="medical!modifyMedicalAfter.action" id="form_med">
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3  control-label no-padding-right" for="form-field-1"> <span style="color:#b20202;">* </span>病情信息： </label>

											<div class="col-sm-9">
												<textarea class="form-control limited" tip="请在这里输入病情信息" errormsg="请填写有效内容！"  datatype="s" name="medical.medical_msg" id="form-field-9"   style="margin: 0px 492px 0px 0px; width: 356px; height: 44px;">${medical.medical_msg }</textarea>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-9"><span style="color:#b20202;">* </span> 医诊结果： </label>

											<div class="col-sm-9">
												<textarea class="form-control limited" tip="请在这里输入医诊结果" errormsg="请填写有效内容！"  datatype="s" name="medical.medical_result" id="form-field-9"  style="margin: 0px 492px 0px 0px; width: 356px; height: 44px;">${medical.medical_result }</textarea>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
