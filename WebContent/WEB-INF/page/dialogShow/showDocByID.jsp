	...
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_ID }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_name }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				...
				<c:if test="${doctorBaseInfo.doctorInfo_sex==0 }">女</c:if></span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_birthday }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_address }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_record }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_position }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_phone }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_email }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			<div class="profile-info-name"  style="width:120px;height:31px;">擅长治疗的疾病：</div>
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_disease }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${doctorBaseInfo.doctorInfo_Oaddress }</span>
			</div>
		</div>
	</div>
