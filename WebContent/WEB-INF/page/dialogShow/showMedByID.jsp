...
<body>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${medical.medical_ID }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			<div class="profile-info-name">确诊病情信息：</div>
			<div class="profile-info-value">
				<span>${medical.medical_msg }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			<div class="profile-info-name">医诊结果：</div>
			<div class="profile-info-value">
				<span>${medical.medical_result }
				<%-- <c:if test="">男</c:if>
				<c:if test="${medical.medical_result==0 }">女</c:if> --%>
				</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${medical.medical_time }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>
					<c:if test="${medical.medical_state==1}">确认</c:if>
					<c:if test="${medical.medical_state==0}">未确认</c:if>
				</span>
			</div>
		</div>
	</div>
