	...
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${registered.registered_ID }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			<div class="profile-info-name">病症信息：</div>
			<div class="profile-info-value">
				<span>${registered.registered_info }</span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			<div class="profile-info-name">预约状态：</div>
			<div class="profile-info-value">
				<span>
				<c:if test="${registered.registered_state==1 }">已就诊</c:if>
				<c:if test="${registered.registered_state==0 }">未就诊</c:if></span>
			</div>
		</div>
	</div>
	<div class="profile-user-info">
		<div class="profile-info-row">
			...
			<div class="profile-info-value">
				<span>${registered.registered_time }</span>
			</div>
		</div>
	</div>
